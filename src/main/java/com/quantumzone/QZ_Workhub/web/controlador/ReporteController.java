...
public class ReporteController {
    ...
    public ResponseEntity<ReporteDto> getReporteById(
            @PathVariable @Parameter(description = "ID del reporte") Long id) {
        try{
            ReporteDto repo = reporteService.findById(id);
    ...
    public ResponseEntity<ReporteDto> createReporte(
            @RequestBody @Parameter(description = "Datos del reporte a crear") ReporteDto reporte) {
        ReporteDto nuevoReporte = reporteService.save(reporte);
    ...
    public ResponseEntity<ReporteDto> updateReporte(
            @RequestBody @Parameter(description = "id del reporte") Long id,
            @RequestBody @Parameter(description = "Datos actualizados del reporte") ReporteDto reporte) {
        ReporteDto updatedReporte = reporteService.update(id, reporte);
